...
INSERT INTO attractions VALUES
    ...
    ('Crocodile Beck', 'Water Beasts await you on this walking tour of Crocodile Beck.', 'Animal World', 'Grand Duck Prairie', 'Open', '08:00', '20:00', 20, 84, null, 1, 0, 0),
    ...
    ('Rainforest Trails', 'Let your adventurous side roam free on the Rainforest Trails.', 'Animal World', 'Wandering Grassland', 'Open', '08:00', '22:00', 10, null, 60, 1, 0, 0),
    ('Serenity Safari', 'See the Savanna and all the wildlife living there.', 'Animal World', 'Wandering Grassland', 'Open', '08:00', '22:00', 5, null, 60, 1, 0, 0),
    ('The Smirkus Big Top', 'Race through The Smirkus Big Top and Save Little Blue.', 'Animal World', 'Pleasant Territory', 'Closed', null, null, 20, 84, null, 1, 0, 0),
    ('Woodstino Volcano', 'Explosions are abundant at this mysterious place.', 'Animal World', 'Pleasant Territory', 'Open', '08:00', '20:00', 20, 84, 60, 1, 1, 1),
    ('Downhill Mining Company Railroad', 'There is only one place that this mine train is headed and that is downhill!', 'Animal World', 'Pleasant Territory', 'Open', '08:00', '20:00', 20, 84, 60, 0, 0, 0),
    ...
    ('Rock to the Top', 'Slide down guitar strings aboard a super speed car.', 'Sunset Studios', 'Oak Boulevard', 'Open', '10:00', '20:00', 90, 84, null, 1, 1, 1),
    ('Ride the Musicals', 'Take a tour through some of your favorite movie musicals. Sing-a-long! You know the words!', 'Sunset Studios', 'Oak Boulevard', 'Open', '09:00', '19:00', 35, null, 48, 1, 1, 1),
    ('Studio Tram Tour', 'Here is your chance to get backstage on one of our movies.', 'Sunset Studios', 'Backlot', 'Open', '09:00', '21:00', 10, null, 60, 1, 1, 1),
    ('Digging Grounds Play Area', 'Children of all ages can explore the Digging Grounds.', 'Sunset Studios', 'Backlot', 'Closed', null, null, 5, null, 60, 1, 1, 1),
    ('Disaster Canyon', 'Watch out for falling rocks as you enter the arena of our special effects.', 'Sunset Studios', 'Backlot', 'Open', '09:00', '21:00', 5, null, 60, 1, 1, 1),
    ('Escape from the Lost Planet The Ride', 'You saw it on the big screen, now experience it live!', 'Sunset Studios', 'Commissary Courtyard', 'Open', '09:00', '19:00', 20, 84, null, 1, 1, 1),
    ('You Could Be in the Movies Too', 'Here is your chance to be in the movies. Check your times guide for auditions times.', 'Sunset Studios', 'Commissary Courtyard', 'Open', '09:00', '20:00', 120, 84, 60, 1, 1, 1),
    ('Space Marine Training Academy', 'This is it, rookie! Enter the SMTA and save earth!', 'Sunset Studios', 'Commissary Courtyard', 'Open', '09:00', '20:00', 20, 84, 60, 1, 0, 0),
    ...
    ('The Enchanted Swing', 'Find out the true secret behind the curse, take a ride on The Haunted Swing!', 'Tulip Gardens', 'Stone Lake Meadows', 'Closed', null, null, 0, 84, null, 0, 0, 0),
    ('Winterborg Hill Dippers', 'An exhilarating thrill ride over the peaks of Winterborg Hill.', 'Tulip Gardens', 'Elm Grounds', 'Closed', null, null, 0, null, 60, 1, 0, 0),
    ('The Haunted Caverns', 'Enter the Haunted Caverns, if you dare!', 'Tulip Gardens', 'Elm Grounds', 'Closed', null, null, 0, null, 60, 1, 0, 0),
    ('The Rickety Old Gold Mine', 'There be gold down those mines! Hold on to your hats.', 'Tulip Gardens', 'Pioneer Plaza', 'Closed', null, null, 0, 84, null, 1, 1, 1),
    ('Turbulent River Adventure', 'Climb aboard a log and slide down the Turbulent River Adventure.', 'Tulip Gardens', 'Pioneer Plaza', 'Closed', null, null, 0, 84, null, 1, 1, 1),
    ('The Paranormal Estate', 'Come and investigate the ghost sightings. Once you enter, you may not exit.', 'Tulip Gardens', 'Pioneer Plaza', 'Closed', null, null, 0, 84, 60, 1, 1, 1),
    ('Stampede Racers', 'Saddle up and hold on to your horses on this wild ride through the west!', 'Tulip Gardens', 'Pioneer Plaza', 'Closed', null, null, 0, 84, 60, 0, 1, 1);
